...
exports.changeBranchSafely = function (repoDirPath, branch) {
    return __awaiter(this, void 0, void 0, function* () {
        yield exports.resetHard(repoDirPath, "HEAD");
        yield exports.cleanCurrentBranch(repoDirPath);
        yield exports.forceChangeBranch(repoDirPath, branch);
        yield exports.pullCurrentBranch(repoDirPath);
    });
};
exports.clone = function (remoteRepoPath, cwd, dirname = "") {
    return __awaiter(this, void 0, void 0, function* () {
        return yield exports.execCommand(`git clone ${remoteRepoPath} ${dirname}`, cwd);
    });
};
...
exports.hasConflict = function (repoDirPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const conflict = exports.UNMERGE_STATUS.some(mergeStatus => Array.isArray(status[mergeStatus]) && status[mergeStatus].length > 0);
        return conflict;
    });
};
