export declare type UNMERGE = "DD" | "AU" | "UA" | "UD" | "DU" | "AA" | "UU";
export declare const UNMERGE_STATUS: UNMERGE[];
...
export declare const changeBranchSafely: (repoDirPath: string, branch: string) => Promise<void>;
export declare const clone: (remoteRepoPath: string, cwd: string, dirname?: string) => Promise<string>;
export declare const submitCommit: (repoDirPath: string, commitMessage: string, modifyFileChecker?: string | string[] | ((files: string[]) => string[]) | undefined) => Promise<boolean>;
/**
 *
